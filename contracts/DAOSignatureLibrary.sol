...
/**
 * @title DAOSignatureLibrary
 * @dev Library for signature validation functions
 */
library DAOSignatureLibrary {
    // Error definitions
    ...
    bytes32 public constant REVEALVOTE_TYPEHASH = keccak256("RevealVote(uint256 proposalId,uint8 support,uint256 salt)");
    
    /**
     * @dev Helper function to hash a structured message according to EIP-712
     */
    ...
    /**
     * @dev Validates a vote signature for castVoteBySig
     */
    ...
    /**
     * @dev Validates an extended vote signature for castVoteWithReasonAndParamsBySig
     */
    ...
    /**
     * @dev Validates a reveal vote signature
     */

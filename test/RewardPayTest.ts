...
describe("GovernorsRewardPay Tests", function () {
  ...
  describe("Basic Token Transfers", function () {
    it("Should allow owner to withdraw funds", async function () {
      const { GovernorsRewardPay, TestToken, deployer, user1 } = await loadFixture(deployRewardFixture);
    ...
    it("Should allow claiming rewards", async function () {
      const { GovernorsRewardPay, TestToken, DAOVoting, user1 } = await loadFixture(deployRewardFixture);
